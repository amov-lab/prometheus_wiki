...
launch_basic
>>>>>>>>>>>>>>>>>>
p450_circle_det.launch

p450_gps_onboard.launch

p450_landpad_det.launch

p450_vio_onboard.launch
...
launch_control
>>>>>>>>>>>>>>>>>>>>
p450_gps_control.launch

p450_vio_control.launch

launch_detection
>>>>>>>>>>>>>>>>>>>>>>
p450_indoor_circle_tracking.launch

p450_indoor_landing_static_target.launch

p450_outdoor_circle_tracking.launch

p450_outdoor_landing_static_target.launch
...
p450_indoor_astar_2dlidar.launch
...
.. image:: ../../images/p450/软件介绍/p450_experiment.png
   :height: 766px
   :width: 1023 px
   :scale: 70 %
   :alt: None
