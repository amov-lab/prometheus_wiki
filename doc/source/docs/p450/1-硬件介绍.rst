...
.. attention::
    下列展示的所有功能适配NX版的p450，Nano版的p450目前所支持的功能为室内外;定点、指点、二维码降落、圆框跟踪，操作与NX版的相同，在室内外操作时，注意查看自己的位置源是否更改，即aid与hgt两个参数，后面介绍地面站安装教程时会详细介绍如何更改参数。



最高配置为 P450+T265+D435I+S1+单目（NX版）
