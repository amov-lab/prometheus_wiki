...
先将无人机摆放在降落二维码附近，可放在二维码的前后左右上等位置，注意不要距离太远，否则起飞后摄像头无法检测到二维码。且机头方向注意要和二维码正方向一致，二维码正方向如下图所示。
...
.. image:: ../../images/p450/室内降落/1启动自主降落脚本.png
   :alt: None
   :align: center
...
.. image:: ../../images/p450/室内降落/1起飞.png
   :alt: None
   :align: center
...
.. image:: ../../images/p450/室内降落/2起飞.png
   :alt: None
   :align: center

降落完成后会无人机自动上锁

.. image:: ../../images/p450/室内降落/2落地.png
   :alt: None
   :align: center
...
.. raw:: html
   ...
   <iframe   width="696" height="422" src="//player.bilibili.com/player.html?aid=549649530&bvid=BV1Mi4y1Z7u6&cid=458112050&page=2" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>