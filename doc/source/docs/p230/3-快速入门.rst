...
.. raw:: html
   ...
   <iframe width="696" height="422" src="//player.bilibili.com/player.html?aid=251418301&bvid=BV1pv411T7f1&cid=482496491&page=2" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
...
<<<<<<< HEAD
将配送的小米路由器上电后，再将飞机上电。用电脑连接到小米路由器
的wifi，wifi名为P230_xxx(XXX为飞机编号)。

.. image:: ../../images/p230/noma_connect/noma_conn1.png
   :alt: None
   :align: center



打开谷歌浏览器，进入小米路由器的Web设置页面，IP为192.168.32.1，
点击终端设备，即可查看到连接到网络的终端和对应的IP地址。


.. image:: ../../images/p230/noma_connect/noma_conn3.png
=======
...
.. image:: ../../images/p230/noma_connect/noma_conn4.png
   :alt: None
   :align: center
...
.. image:: ../../images/p230/noma_connect/noma_conn5.png
   :align: center
...
.. image:: ../../images/p230/noma_connect/noma_conn2.png
   :align: center

按照上述步骤操作，会自动生成如下图所示用红框标起的链接，点击“Connect”。

.. image:: ../../images/p230/noma_connect/noma_conn6.png
   :alt: None
   :align: center
